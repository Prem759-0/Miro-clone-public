...
import {
 ...
 import { LiveObject } from "@liveblocks/client";
  import {
    ...
    penPointsToPathLayer, colorToCss} from "@/lib/utils"
...
export const Canvas = ({ 
  ...
  const insertLayer = useMutation((
    ...
    layerType: LayerType.Ellipse | LayerType.Reactangle | LayerType.Path | LayerType.Text | LayerType.Note,
    position: Point,
  )=>{
...
const layerIdsToColorSelection = useMemo(()=>{
     ...
     for(const user of selections){
      ...
      for (const layerId of selection) {
        const hex = connectionIdToColor(connectionId);
        layerIdsToColorSelection[layerId] = hex;
      }
     }
